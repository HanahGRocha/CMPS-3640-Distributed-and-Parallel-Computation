...
int main(int argc, char* argv[])
{
    ...
    //Remove these lines when using runtime clause or auto
    //change schedule here
    omp_set_schedule(omp_sched_static, 1000);
    //change for output results
    printf("schedule=static chunk=1000\n");
...
#pragma omp parallel for reduction(+:sum) schedule(runtime) //switch to auto for output
